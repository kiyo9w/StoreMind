...
-d "{
  \"question\": \"How exactly did today's weather forecast affect the order quantities in this plan?\",
  \"plan_id\": \"$PLAN_ID\"
}" > demo_scripts/output_weather.json
echo "Weather impact explained: demo_scripts/output_weather.json"
