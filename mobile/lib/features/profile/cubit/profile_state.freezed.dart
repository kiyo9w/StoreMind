...
mixin _$ProfileState {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, profile, isLoading, isLoaded, error);

  @override
  String toString() {
    return 'ProfileState(profile: $profile, isLoading: $isLoading, isLoaded: $isLoaded, error: $error)';
  }
}
...
abstract mixin class $ProfileStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {ProfileData? profile, bool isLoading, bool isLoaded, String? error});
...
extension ProfileStatePatterns on ProfileState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ProfileState() when $default != null:
        return $default(
            _that.profile, _that.isLoading, _that.isLoaded, _that.error);
      case _:
        return orElse();
    }
  }
